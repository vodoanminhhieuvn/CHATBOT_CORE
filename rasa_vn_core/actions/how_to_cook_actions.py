    ...
    async def run(
        ...
        try:
            ...
            if ingredient_list != []:
                ...
                dispatcher.utter_message("Bạn có thể xem chi tiết cách nhập nguyên liệu bằng cách ấn nút ở dưới")
            ...
            if cook_technique_list != []:
                ...
                dispatcher.utter_message("Bạn có thể xem chi tiết cách nhập cách nấu bằng cách ấn nút ở dưới")
